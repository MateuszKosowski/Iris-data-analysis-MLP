...
def learn(choice, num_epochs, precision, shuffle_data, use_momentum, mlp_network, train_features, train_labels_vector, num_samples = None,):

    #Czyszczenie pliku do zapisu
    with open("mse_log_train.txt", "w") as f:
        f.write("")
    ...
    if choice == "epoch":
        ...
        if num_epochs % 10 != 0:
            ...
            with open("mse_log_train.txt", "a") as f:
...
def learn_one_epoch(num_samples, num_epochs, use_momentum, mlp_network, train_features_to_use, train_label_vector_to_use, epoch = 0):
